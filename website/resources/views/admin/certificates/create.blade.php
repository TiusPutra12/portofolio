...
<div class="animate-fade-in max-w-2xl mx-auto">
    ...
    <div class="admin-card p-6 sm:p-8">
        <div class="mb-6">
            <p class="font-mono text-xs text-primary-400 mb-1">// new certificate()</p>
            <h2 class="text-xl font-bold text-white">Tambah Sertifikat Baru</h2>
        </div>

        <form method="POST" action="/admin/certificates" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                <label for="image">Gambar Sertifikat <span class="req">*</span></label>
                <div class="relative">
