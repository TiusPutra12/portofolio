...
<div class="animate-fade-in max-w-2xl mx-auto">
    ...
    <div class="admin-card p-6 sm:p-8">
        <div class="mb-6">
            <p class="font-mono text-xs text-neon-400 mb-1">// new project()</p>
            <h2 class="text-xl font-bold text-white">Tambah Proyek Baru</h2>
        </div>
        ...
        <form method="POST" action="/admin/projects" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    class="input-field" placeholder="Deskripsi singkat proyek...">{{ old('description') }}</textarea>
            ...
            <div>
                <label for="image">Screenshot (opsional)</label>
                <div class="relative">
